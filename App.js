...
// ✅ UPDATED: Profile sync between screens and drawer
    ...
    >
      ...
      <View style={styles.drawerHeader}>
        ...
        >
          ...
          <Text style={styles.drawerSubEmail} numberOfLines={1}>
            {user?.email || ""}
          </Text>
        </TouchableOpacity>
      </View>
      ...
      <View style={{ flex: 1, paddingTop: 10 }}>
        ...
        >
          {loggingOut ? (
            <ActivityIndicator size="small" color={COLORS.accentBlush} />
          ) : (
            <>
  ...
  useEffect(() => {
    ...
    const run = async () => {
      ...
      try {
        ...
        console.log("📱 Registering Expo push token for user:", user.id);
...
const styles = StyleSheet.create({
  ...
  drawerAvatar: {
    ...
    borderRadius: 32,
    borderWidth: 2,
    borderColor: COLORS.accentBlush + "60",
  },
