...
export default function SettingsScreen() {
  ...
  const deleteUserDataFromFirestore = useCallback(async (userId, appId) => {
    try {
      ...
      goalsSnapshot.forEach((goalDoc) => batch.delete(goalDoc.ref));
  ...
  }, [user, appId, deleteConfirmation, isConnected, deleteUserDataFromFirestore, setUser]);
